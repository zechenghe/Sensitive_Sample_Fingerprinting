...
def sensitive_sample_gen(
    ...
    for i in range(n_iter):
        ...
        df_dw = torch.autograd.grad(softmax_out[max_i], w, create_graph=True)[0]
        loss = -torch.mean(df_dw**2)
...
def main():
    ...
    parser.add_argument('--sensitivity_per_weight_th', type=float, default = 4.0, help='Threshold to determine if the generation is successful')
