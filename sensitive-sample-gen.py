...
def main():
    ...
    parser.add_argument('--sensitivity_per_weight_th', type=float, default = 0.5, help='Threshold to determine if the generation is successful')
